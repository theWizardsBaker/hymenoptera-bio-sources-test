...
public class SNPShadow implements SNP, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.SNP.tissue
    ...
    // Attr: org.intermine.model.bio.SNP.pValue
    ...
    // Attr: org.intermine.model.bio.SNP.tssDistance
    protected java.lang.Integer tssDistance;
    public java.lang.Integer getTssDistance() { return tssDistance; }
    public void setTssDistance(final java.lang.Integer tssDistance) { this.tssDistance = tssDistance; }
    ...
    @Override public String toString() { return "SNP [chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", id=" + id + ", length=" + length + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", pValue=" + pValue + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", score=" + score + ", scoreType=" + (scoreType == null ? "null" : "\"" + scoreType + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", tissue=" + (tissue == null ? "null" : "\"" + tissue + "\"") + ", tssDistance=" + tssDistance + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("tssDistance".equals(fieldName)) {
            return tssDistance;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("tssDistance".equals(fieldName)) {
            tssDistance = (java.lang.Integer) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (tssDistance != null) {
            sb.append("$_^atssDistance$_^").append(tssDistance);
        }
        if (gene != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) && "atssDistance".equals(notXml[i])) {
                i++;
                tssDistance = Integer.valueOf(notXml[i]);
                i++;
            }
