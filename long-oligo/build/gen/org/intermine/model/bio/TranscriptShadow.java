...
public class TranscriptShadow implements Transcript, ShadowClass
{
    ...
    // Col: org.intermine.model.bio.Transcript.microarrayOligos
    protected java.util.Set<org.intermine.model.bio.MicroarrayOligo> microarrayOligos = new java.util.HashSet<org.intermine.model.bio.MicroarrayOligo>();
    public java.util.Set<org.intermine.model.bio.MicroarrayOligo> getMicroarrayOligos() { return microarrayOligos; }
    public void setMicroarrayOligos(final java.util.Set<org.intermine.model.bio.MicroarrayOligo> microarrayOligos) { this.microarrayOligos = microarrayOligos; }
    public void addMicroarrayOligos(final org.intermine.model.bio.MicroarrayOligo arg) { microarrayOligos.add(arg); }
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("microarrayOligos".equals(fieldName)) {
            return microarrayOligos;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("microarrayOligos".equals(fieldName)) {
            microarrayOligos = (java.util.Set) value;
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        microarrayOligos = new ProxyCollection<org.intermine.model.bio.MicroarrayOligo>(os, this, "microarrayOligos", org.intermine.model.bio.MicroarrayOligo.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("microarrayOligos".equals(fieldName)) {
            microarrayOligos.add((org.intermine.model.bio.MicroarrayOligo) element);
        } else if ("overlappingFeatures".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        if ("microarrayOligos".equals(fieldName)) {
            return org.intermine.model.bio.MicroarrayOligo.class;
        }
        if ("overlappingFeatures".equals(fieldName)) {
