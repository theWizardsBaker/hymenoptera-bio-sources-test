...
public class AlleleShadow implements Allele, ShadowClass
{
    ...
    // Ref: org.intermine.model.bio.Allele.publication
    ...
    // Col: org.intermine.model.bio.Allele.highLevelPhenotypeTerms
    protected java.util.Set<org.intermine.model.bio.MammalianPhenotypeTerm> highLevelPhenotypeTerms = new java.util.HashSet<org.intermine.model.bio.MammalianPhenotypeTerm>();
    public java.util.Set<org.intermine.model.bio.MammalianPhenotypeTerm> getHighLevelPhenotypeTerms() { return highLevelPhenotypeTerms; }
    public void setHighLevelPhenotypeTerms(final java.util.Set<org.intermine.model.bio.MammalianPhenotypeTerm> highLevelPhenotypeTerms) { this.highLevelPhenotypeTerms = highLevelPhenotypeTerms; }
    public void addHighLevelPhenotypeTerms(final org.intermine.model.bio.MammalianPhenotypeTerm arg) { highLevelPhenotypeTerms.add(arg); }
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("highLevelPhenotypeTerms".equals(fieldName)) {
            return highLevelPhenotypeTerms;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("highLevelPhenotypeTerms".equals(fieldName)) {
            highLevelPhenotypeTerms = (java.util.Set) value;
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        highLevelPhenotypeTerms = new ProxyCollection<org.intermine.model.bio.MammalianPhenotypeTerm>(os, this, "highLevelPhenotypeTerms", org.intermine.model.bio.MammalianPhenotypeTerm.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("highLevelPhenotypeTerms".equals(fieldName)) {
            highLevelPhenotypeTerms.add((org.intermine.model.bio.MammalianPhenotypeTerm) element);
        } else if ("genotypes".equals(fieldName)) {
