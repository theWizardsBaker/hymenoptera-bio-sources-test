...
public class MiRNATargetShadow implements MiRNATarget, ShadowClass
{
    public static final Class<MiRNATarget> shadowOf = MiRNATarget.class;
    // Attr: org.intermine.model.bio.MiRNATarget.pvalue
    protected java.lang.Float pvalue;
    public java.lang.Float getPvalue() { return pvalue; }
    public void setPvalue(final java.lang.Float pvalue) { this.pvalue = pvalue; }

    // Ref: org.intermine.model.bio.MiRNATarget.mirnagene
    protected org.intermine.model.InterMineObject mirnagene;
    public org.intermine.model.bio.Gene getMirnagene() { if (mirnagene instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.Gene) ((org.intermine.objectstore.proxy.ProxyReference) mirnagene).getObject()); }; return (org.intermine.model.bio.Gene) mirnagene; }
    public void setMirnagene(final org.intermine.model.bio.Gene mirnagene) { this.mirnagene = mirnagene; }
    public void proxyMirnagene(final org.intermine.objectstore.proxy.ProxyReference mirnagene) { this.mirnagene = mirnagene; }
    public org.intermine.model.InterMineObject proxGetMirnagene() { return mirnagene; }

    // Ref: org.intermine.model.bio.MiRNATarget.target
    protected org.intermine.model.InterMineObject target;
    public org.intermine.model.bio.MRNA getTarget() { if (target instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.MRNA) ((org.intermine.objectstore.proxy.ProxyReference) target).getObject()); }; return (org.intermine.model.bio.MRNA) target; }
    public void setTarget(final org.intermine.model.bio.MRNA target) { this.target = target; }
    ...
    @Override public boolean equals(Object o) { return (o instanceof MiRNATarget && id != null) ? id.equals(((MiRNATarget)o).getId()) : this == o; }
    @Override public int hashCode() { return (id != null) ? id.hashCode() : super.hashCode(); }
    @Override public String toString() { return "MiRNATarget [chromosome=" + (chromosome == null ? "null" : (chromosome.getId() == null ? "no id" : chromosome.getId().toString())) + ", chromosomeLocation=" + (chromosomeLocation == null ? "null" : (chromosomeLocation.getId() == null ? "no id" : chromosomeLocation.getId().toString())) + ", id=" + id + ", length=" + length + ", mirnagene=" + (mirnagene == null ? "null" : (mirnagene.getId() == null ? "no id" : mirnagene.getId().toString())) + ", name=" + (name == null ? "null" : "\"" + name + "\"") + ", organism=" + (organism == null ? "null" : (organism.getId() == null ? "no id" : organism.getId().toString())) + ", primaryIdentifier=" + (primaryIdentifier == null ? "null" : "\"" + primaryIdentifier + "\"") + ", pvalue=" + pvalue + ", score=" + score + ", scoreType=" + (scoreType == null ? "null" : "\"" + scoreType + "\"") + ", secondaryIdentifier=" + (secondaryIdentifier == null ? "null" : "\"" + secondaryIdentifier + "\"") + ", sequence=" + (sequence == null ? "null" : (sequence.getId() == null ? "no id" : sequence.getId().toString())) + ", sequenceOntologyTerm=" + (sequenceOntologyTerm == null ? "null" : (sequenceOntologyTerm.getId() == null ? "no id" : sequenceOntologyTerm.getId().toString())) + ", symbol=" + (symbol == null ? "null" : "\"" + symbol + "\"") + ", target=" + (target == null ? "null" : (target.getId() == null ? "no id" : target.getId().toString())) + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("pvalue".equals(fieldName)) {
            return pvalue;
        }
        if ("mirnagene".equals(fieldName)) {
            if (mirnagene instanceof ProxyReference) {
                return ((ProxyReference) mirnagene).getObject();
            } else {
                return mirnagene;
            }
        }
        ...
        if (!org.intermine.model.bio.MiRNATarget.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("pvalue".equals(fieldName)) {
            pvalue = (java.lang.Float) value;
        } else if ("mirnagene".equals(fieldName)) {
            mirnagene = (org.intermine.model.InterMineObject) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.MiRNATarget.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.MiRNATarget.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.MiRNATargetShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.MiRNATarget");
        if (pvalue != null) {
            sb.append("$_^apvalue$_^").append(pvalue);
        }
        if (mirnagene != null) {
            sb.append("$_^rmirnagene$_^").append(mirnagene.getId());
        }
        if (target != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.MiRNATargetShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.MiRNATarget)");
        }
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) && "apvalue".equals(notXml[i])) {
                i++;
                pvalue = Float.valueOf(notXml[i]);
                i++;
            }
            if ((i < notXml.length) &&"rmirnagene".equals(notXml[i])) {
                i++;
                mirnagene = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.Gene.class);
                i++;
            };
            if ((i < notXml.length) &&"rtarget".equals(notXml[i])) {
                i++;
                target = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.MRNA.class);
                i++;
            };
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.MiRNATarget.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.MiRNATarget.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
