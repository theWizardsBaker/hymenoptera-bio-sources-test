...
public class AtlasExpressionShadow implements AtlasExpression, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.AtlasExpression.tStatistic
    protected java.lang.Double tStatistic;
    public java.lang.Double getTStatistic() { return tStatistic; }
    public void setTStatistic(final java.lang.Double tStatistic) { this.tStatistic = tStatistic; }
    ...
    // Attr: org.intermine.model.bio.AtlasExpression.pValue
    ...
    // Ref: org.intermine.model.bio.AtlasExpression.probe
    protected org.intermine.model.InterMineObject probe;
    public org.intermine.model.bio.ProbeSet getProbe() { if (probe instanceof org.intermine.objectstore.proxy.ProxyReference) { return ((org.intermine.model.bio.ProbeSet) ((org.intermine.objectstore.proxy.ProxyReference) probe).getObject()); }; return (org.intermine.model.bio.ProbeSet) probe; }
    public void setProbe(final org.intermine.model.bio.ProbeSet probe) { this.probe = probe; }
    ...
    @Override public String toString() { return "AtlasExpression [condition=" + (condition == null ? "null" : "\"" + condition + "\"") + ", expression=" + (expression == null ? "null" : "\"" + expression + "\"") + ", gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", id=" + id + ", pValue=" + pValue + ", probe=" + (probe == null ? "null" : (probe.getId() == null ? "no id" : probe.getId().toString())) + ", tStatistic=" + tStatistic + ", type=" + (type == null ? "null" : "\"" + type + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("tStatistic".equals(fieldName)) {
            return tStatistic;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        if ("tStatistic".equals(fieldName)) {
            tStatistic = (java.lang.Double) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (tStatistic != null) {
            sb.append("$_^atStatistic$_^").append(tStatistic);
        }
        if (type != null) {
            sb.append("$_^atype$_^");
            String string = type;
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            int startI = i;
            if ((i < notXml.length) && "atStatistic".equals(notXml[i])) {
                i++;
                tStatistic = Double.valueOf(notXml[i]);
                i++;
            }
            ...
            if ((i < notXml.length) &&"rprobe".equals(notXml[i])) {
                i++;
                probe = new ProxyReference(os, Integer.valueOf(notXml[i]), org.intermine.model.bio.ProbeSet.class);
                i++;
            };
