...
public class ProbeSetShadow implements ProbeSet, ShadowClass
{
    public static final Class<ProbeSet> shadowOf = ProbeSet.class;
    // Attr: org.intermine.model.bio.ProbeSet.description
    protected java.lang.String description;
    public java.lang.String getDescription() { return description; }
    public void setDescription(final java.lang.String description) { this.description = description; }

    // Col: org.intermine.model.bio.ProbeSet.genes
    ...
    // Col: org.intermine.model.bio.ProbeSet.atlasExpression
    protected java.util.Set<org.intermine.model.bio.AtlasExpression> atlasExpression = new java.util.HashSet<org.intermine.model.bio.AtlasExpression>();
    public java.util.Set<org.intermine.model.bio.AtlasExpression> getAtlasExpression() { return atlasExpression; }
    public void setAtlasExpression(final java.util.Set<org.intermine.model.bio.AtlasExpression> atlasExpression) { this.atlasExpression = atlasExpression; }
    public void addAtlasExpression(final org.intermine.model.bio.AtlasExpression arg) { atlasExpression.add(arg); }
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("atlasExpression".equals(fieldName)) {
            return atlasExpression;
        }
        ...
        if (!org.intermine.model.bio.ProbeSet.class.equals(getClass())) {
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("atlasExpression".equals(fieldName)) {
            atlasExpression = (java.util.Set) value;
    ...
    public Class<?> getFieldType(final String fieldName) {
        ...
        if (!org.intermine.model.bio.ProbeSet.class.equals(getClass())) {
            return TypeUtil.getFieldType(org.intermine.model.bio.ProbeSet.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
    public StringConstructor getoBJECT() {
        if (!org.intermine.model.bio.ProbeSetShadow.class.equals(getClass())) {
            return NotXmlRenderer.render(this);
        }
        StringConstructor sb = new StringConstructor();
        sb.append("$_^org.intermine.model.bio.ProbeSet");
        if (description != null) {
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        if (!org.intermine.model.bio.ProbeSetShadow.class.equals(getClass())) {
            throw new IllegalStateException("Class " + getClass().getName() + " does not match code (org.intermine.model.bio.ProbeSet)");
        }
        ...
        atlasExpression = new ProxyCollection<org.intermine.model.bio.AtlasExpression>(os, this, "atlasExpression", org.intermine.model.bio.AtlasExpression.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("genes".equals(fieldName)) {
            ...
            atlasExpression.add((org.intermine.model.bio.AtlasExpression) element);
        } else if ("overlappingFeatures".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if ("atlasExpression".equals(fieldName)) {
            return org.intermine.model.bio.AtlasExpression.class;
        }
        if ("overlappingFeatures".equals(fieldName)) {
        ...
        if (!org.intermine.model.bio.ProbeSet.class.equals(getClass())) {
            return TypeUtil.getElementType(org.intermine.model.bio.ProbeSet.class, fieldName);
        }
        throw new IllegalArgumentException("Unknown field " + fieldName);
    }
}
