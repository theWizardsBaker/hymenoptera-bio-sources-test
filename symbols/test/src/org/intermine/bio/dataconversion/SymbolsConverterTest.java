...
public class SymbolsConverterTest extends ItemsTestCase
{
    Model model = Model.getInstanceByName("genomic");
    SymbolsConverter converter;
    MockItemWriter itemWriter;

    public SymbolsConverterTest(String arg) {
        super(arg);
    }
    ...
    public void setUp() throws Exception {
        ...
        converter = new SymbolsConverter(itemWriter, model);
        converter.setSymbolsOrganisms("7227 10090 9606");
    ...
    public void testProcess() throws Exception {
        ...
        Set<org.intermine.xml.full.Item> expected = readItemSet("SymbolsConverterTest_tgt.xml");
