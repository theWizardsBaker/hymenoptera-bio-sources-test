 ...
 * @author
 */
public class AliasesTranscriptConverter extends BioFileConverter
{
    //
     ...
     */
    public AliasesTranscriptConverter(ItemWriter writer, Model model) {
    ...
    public void process(Reader reader) throws Exception {
        ...
        while (lineIter.hasNext()) {
            ...
            if (geneItemMap.containsKey(genePrimaryIdentifier)) {
                ...
                geneItem = createItem("Transcript");
