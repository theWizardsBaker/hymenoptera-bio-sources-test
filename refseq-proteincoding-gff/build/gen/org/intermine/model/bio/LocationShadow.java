...
public class LocationShadow implements Location, ShadowClass
{
    ...
    // Attr: org.intermine.model.bio.Location.doNotComputeOverlaps
    protected java.lang.String doNotComputeOverlaps;
    public java.lang.String getDoNotComputeOverlaps() { return doNotComputeOverlaps; }
    public void setDoNotComputeOverlaps(final java.lang.String doNotComputeOverlaps) { this.doNotComputeOverlaps = doNotComputeOverlaps; }
    ...
    @Override public String toString() { return "Location [doNotComputeOverlaps=" + (doNotComputeOverlaps == null ? "null" : "\"" + doNotComputeOverlaps + "\"") + ", end=" + end + ", feature=" + (feature == null ? "null" : (feature.getId() == null ? "no id" : feature.getId().toString())) + ", id=" + id + ", locatedOn=" + (locatedOn == null ? "null" : (locatedOn.getId() == null ? "no id" : locatedOn.getId().toString())) + ", start=" + start + ", strand=" + (strand == null ? "null" : "\"" + strand + "\"") + "]"; }
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        if ("strand".equals(fieldName)) {
            return strand;
        }
        if ("doNotComputeOverlaps".equals(fieldName)) {
            return doNotComputeOverlaps;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("doNotComputeOverlaps".equals(fieldName)) {
            doNotComputeOverlaps = (java.lang.String) value;
    ...
    public StringConstructor getoBJECT() {
        ...
        if (doNotComputeOverlaps != null) {
            sb.append("$_^adoNotComputeOverlaps$_^");
            String string = doNotComputeOverlaps;
            while (string != null) {
                int delimPosition = string.indexOf("$_^");
                if (delimPosition == -1) {
                    sb.append(string);
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        for (int i = 2; i < notXml.length;) {
            ...
            if ((i < notXml.length) && "adoNotComputeOverlaps".equals(notXml[i])) {
                i++;
                StringBuilder string = null;
                while ((i + 1 < notXml.length) && (notXml[i + 1].charAt(0) == 'd')) {
                    if (string == null) string = new StringBuilder(notXml[i]);
                ...
                doNotComputeOverlaps = string == null ? notXml[i] : string.toString();
                i++;
            }
