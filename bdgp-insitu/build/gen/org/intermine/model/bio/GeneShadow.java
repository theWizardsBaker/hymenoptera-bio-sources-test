...
public class GeneShadow implements Gene, ShadowClass
{
    ...
    // Col: org.intermine.model.bio.Gene.mRNAExpressionResults
    protected java.util.Set<org.intermine.model.bio.MRNAExpressionResult> mRNAExpressionResults = new java.util.HashSet<org.intermine.model.bio.MRNAExpressionResult>();
    public java.util.Set<org.intermine.model.bio.MRNAExpressionResult> getMRNAExpressionResults() { return mRNAExpressionResults; }
    public void setMRNAExpressionResults(final java.util.Set<org.intermine.model.bio.MRNAExpressionResult> mRNAExpressionResults) { this.mRNAExpressionResults = mRNAExpressionResults; }
    public void addMRNAExpressionResults(final org.intermine.model.bio.MRNAExpressionResult arg) { mRNAExpressionResults.add(arg); }
    ...
    public Object getFieldValue(final String fieldName) throws IllegalAccessException {
        ...
        if ("mRNAExpressionResults".equals(fieldName)) {
            return mRNAExpressionResults;
        }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("mRNAExpressionResults".equals(fieldName)) {
            mRNAExpressionResults = (java.util.Set) value;
    ...
    public void setoBJECT(final String[] notXml, final ObjectStore os) {
        ...
        mRNAExpressionResults = new ProxyCollection<org.intermine.model.bio.MRNAExpressionResult>(os, this, "mRNAExpressionResults", org.intermine.model.bio.MRNAExpressionResult.class);
    ...
    public void addCollectionElement(final String fieldName, final org.intermine.model.InterMineObject element) {
        if ("flankingRegions".equals(fieldName)) {
            ...
            mRNAExpressionResults.add((org.intermine.model.bio.MRNAExpressionResult) element);
        } else if ("exons".equals(fieldName)) {
    ...
    public Class<?> getElementType(final String fieldName) {
        ...
        if ("mRNAExpressionResults".equals(fieldName)) {
            return org.intermine.model.bio.MRNAExpressionResult.class;
        }
        if ("exons".equals(fieldName)) {
