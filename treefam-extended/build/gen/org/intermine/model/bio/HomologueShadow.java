...
public class HomologueShadow implements Homologue, ShadowClass
{
    ...
    @Override public String toString() { return "Homologue [bootstrapScore=" + bootstrapScore + ", gene=" + (gene == null ? "null" : (gene.getId() == null ? "no id" : gene.getId().toString())) + ", homologue=" + (homologue == null ? "null" : (homologue.getId() == null ? "no id" : homologue.getId().toString())) + ", homologyType=" + (homologyType == null ? "null" : "\"" + homologyType + "\"") + ", id=" + id + ", lastCommonAncestor=" + (lastCommonAncestor == null ? "null" : "\"" + lastCommonAncestor + "\"") + ", type=" + (type == null ? "null" : "\"" + type + "\"") + "]"; }
    ...
    public void setFieldValue(final String fieldName, final Object value) {
        ...
        } else if ("homologyType".equals(fieldName)) {
